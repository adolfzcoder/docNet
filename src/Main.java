...
public class Main {
    ...
    public static void main(String[] args){
        ...
        Admin root = new Admin(1,"root", "admin", "0817266158", "01/02/2000", true, "ADMIN", "admin@gmail.com", "admin123", "MALE");
        ...
        Doctor userDoctor = new Doctor(userID, medicalCertificate, yearsOfXP, specialisation, firstName, lastName, telephone, dob, false, "DOCTOR", email, password, gender);

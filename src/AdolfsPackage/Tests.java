...
public class Tests {
    ...
    public static void main(String[] args){
       ...
       */
        ...
        Doctor userDoctor = new Doctor(userID, doctorID, medicalCertificate, yearsOfXP, specialisation, firstName, lastName, telephone, dob, false, "DOCTOR", email, password, gender);
